...
function(_ab_rpi64_add_sdl2_target name soname)
    ...
    set_target_properties(${name} PROPERTIES
        ...
        INTERFACE_INCLUDE_DIRECTORIES "${_ab_rpi64_devkit_include};${_ab_rpi64_devkit_include}/SDL2"
    )
endfunction()
...
_ab_rpi64_add_sdl2_target(SDL2::SDL2       libSDL2-2.0.so.0)
_ab_rpi64_add_sdl2_target(SDL2::SDL2_image libSDL2_image-2.0.so.0)
_ab_rpi64_add_sdl2_target(SDL2::SDL2_mixer libSDL2_mixer-2.0.so.0)
_ab_rpi64_add_sdl2_target(SDL2::SDL2_ttf   libSDL2_ttf-2.0.so.0)
